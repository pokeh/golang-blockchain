...
import (
	...
	"github.com/pokeh/golang-blockchain/blockchain"
	"github.com/pokeh/golang-blockchain/network"
...
func (cli *CommandLine) validateArgs() {
	if len(os.Args) < 2 {
		cli.printUsage()
		// Exits the app by shutting down the goroutine, unlike os.Exit.
		// We use this to not corrupt data of the database
		runtime.Goexit()
	}
}
